...
INSERT ALL
    ...
    INTO tb_paciente (codPaciente, nome, sexo, dataNasc, endereco, cidade, idade, desconto) VALUES (55, 'Tohru Adachi', 'M', TO_DATE('1998-02-01', 'YYYY-MM-DD'), 'Rua Misoginy, 67', 'Inaba', 27, 20)
SELECT 1 FROM DUAL;
...
INSERT ALL
    ...
    INTO tb_consulta (codConsulta, codPaciente, codMedico, dataConsulta, valorConsulta) VALUES (201, 55, 3, TO_DATE('2023-10-20', 'YYYY-MM-DD'), 0)
SELECT 1 FROM DUAL;
...
-- MUDANÇAS DA LISTA 01.
ALTER TABLE tb_paciente ADD pais VARCHAR2(15);
SELECT * FROM tb_paciente;

ALTER TABLE tb_paciente MODIFY endereco VARCHAR2(28);
SELECT * FROM tb_paciente;

ALTER TABLE tb_paciente DROP COLUMN pais;
SELECT * FROM tb_paciente;

ALTER TABLE tb_paciente MODIFY endereco VARCHAR2(28) NOT NULL;
UPDATE tb_paciente SET endereco = '' WHERE codpaciente = 1;
SELECT * FROM tb_paciente;

UPDATE tb_paciente SET datanasc = '01-09-1990' WHERE codpaciente = 1;
SELECT * FROM tb_paciente;
